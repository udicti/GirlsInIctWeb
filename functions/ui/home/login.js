...
<!--                    <p style="padding: 16px 8px 16px 20px ">Supporting and Empowering Girls and young women in ICT movement</p>-->
                </div>
...
<!--                     <img src="/images/smart.png" width="250px" style="margin: 10px auto">-->
                    ...
                    <p class="text-center text-black-50" style="margin: 0 auto 70px auto">Login</p>
